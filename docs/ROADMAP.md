...
5. Finish stable device identifiers, full parametric EQ, streaming WAV decode, session completeness, localization/accessibility and release packaging validation.
