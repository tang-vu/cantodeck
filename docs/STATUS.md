...
- Portable ZIP build and SHA256 are produced by `scripts/package.ps1`, including exact JUCE source and CantoDeck source. Binaries are unsigned. CI definition exists; no hosted GitHub Actions run has been observed in this session.
