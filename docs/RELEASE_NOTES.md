...
This is not completion of release 0.1 or approval for reliable live karaoke. The owner's latency/vocal-quality complaint remains unresolved by listening evidence. An earlier silent native 30-minute run had three FIFO underruns; a later clean 60-second probe does not erase that result. Actual RTT, external-speaker singing, physical unplug/reconnect, long live playback/recording and storage-fault validation remain open. Complete localization/accessibility and robust crash recovery are also incomplete. Local sessions now retain per-song LRC/TXT associations without opening files at startup. De-esser is deferred.
